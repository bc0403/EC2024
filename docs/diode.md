...
~~8、[optional] PN结加正向电压时，内电场方向与外加电场方向 ________ ，PN结宽度变 ________ 。~~
...
**`CH06-KP2-09`**: 下图中，电容为容值较大的隔直电容，已知二极管的导通电压为 0.7 V，常温下 $V_T$ ≈ 25 mV，请问，当输入 $v_i$ 为有效值是 10 mV 的正弦波小信号时，试求二极管中流过的交流电流的有效值是 ________ 。
...
**`CH06-KP2-16`**: 下图所示为包含理想二极管的电路及其输入信号曲线，则输出信号曲线应为 ________ 。
